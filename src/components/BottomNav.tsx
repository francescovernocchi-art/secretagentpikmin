...
import { Radio, MessageSquare, Target, Trophy, User, FlaskConical, Map, Rocket, ShoppingBag, BookOpen, Skull, Wrench, Send, Home } from "lucide-react";
...
const baseItems = [
  ...
  { to: "/villaggio", icon: Home, label: "Villag." },
